        ...
        <aside className="bg-menu w-60 h-screen flex flex-col py-2">
            ...
            <Scrollbars
                ...
                <div className="py-2 flex flex-col pr-3 my-1">
                    ...
                    {openSubscriptions ? (
                        <AsideButton src="/icons/up.svg" label="Show less" onClick={() => setOpenSubscriptions(false)} asideOpen={asideOpen} />
                    ) : (
                        <AsideButton
                            src="/icons/down.svg"
        ...
        <aside>
            <div className="bg-menu h-screen flex flex-col py-2">
                ...
                <div className="my-1">
                    ...
                    <AsideButton label="Subscriptions" src="/icons/subscriptions.svg" asideOpen={asideOpen} />
